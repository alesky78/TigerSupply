 ...
 * hot core that darkens to red at the edge) and emitting fire-coloured {@link EnergyTrailParticle}
 * squares as it travels. For gameplay it behaves as a standard enemy shot: it is collision-tested by
 * the shot group and removed on hit (default {@link BaseEntity} reaction) or when it leaves the
 * screen.</p>
 */
public class FireBall extends BaseEntity {
	...
	public void renderEntity(Graphics2D dbg) throws Exception {
		...
		Color[] colors = {Color.WHITE, new Color(255, 160, 0), new Color(120, 0, 0)}; // hot core -> red edge
