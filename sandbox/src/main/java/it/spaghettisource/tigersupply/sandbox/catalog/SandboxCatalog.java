...
public class SandboxCatalog {
	...
	private void buildEffects() {
		...
		cases.add(new SandboxCase("ParticleTrailSquare (ember)", Family.EFFECT, (ctx, m, target) ->
				new ParticleTrailSquare(ParticleColorScheme.EMBER, centerX(ctx), centerY(ctx), 12, -120, 0, 0.2f, ctx)));
		cases.add(new SandboxCase("ParticleTrailSquare (energy)", Family.EFFECT, (ctx, m, target) ->
				new ParticleTrailSquare(ParticleColorScheme.ENERGY_TRAIL, centerX(ctx), centerY(ctx), 12, -220, 0, 0.35f, ctx)));
