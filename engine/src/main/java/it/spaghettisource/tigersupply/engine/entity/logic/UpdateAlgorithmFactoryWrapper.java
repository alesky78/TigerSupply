...
/**
 * central point to unify the use of the key for the resources properties
 * 
...
public class UpdateAlgorithmFactoryWrapper {
	...
	/**
	 * 
	 * @param delta						delta*sin: limit max and min reached
	 * @param angleIncrementPerSecond	increase of the angle per second in degree
	 * @param angleStart
	 * @return
	 * @throws Exception
	 */
