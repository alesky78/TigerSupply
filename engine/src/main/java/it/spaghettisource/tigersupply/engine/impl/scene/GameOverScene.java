...
public class GameOverScene extends AbstractGameJPanel {
	...
	public GameOverScene(ApplicationContext context){
	...
	public void internalRenderGame(Graphics2D dbg) throws Exception {
	    ...
	    dbg.setFont(FontRepositoryManager.getInstance().getFont(StaticResources.FONT_TECHNO, 20));
